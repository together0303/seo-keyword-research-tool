      ...
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
                  ...
                  {navigation.map((item) => (
                    <Link
                      ...
                      className={classNames(
                        pathname === item.href
                          ? 'text-white'
                          : 'border-transparent text-surface-800 hover:text-white',
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="h-8 items-center px-4 flex justify-center rounded-md  text-sm text-bold bg-brand hover:bg-brand-600">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex rounded-full bg-white text-sm">
                      ...
                      <Image
                        className="h-8 w-8 rounded-full border border-brand border-2"
                          ...
                          <Menu.Item>
                            {({ active }) => (
                              ...
                              >
                                ...
                                <svg className='fill-brand' width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="-mr-2 flex items-center sm:hidden">
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md  p-2 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-surface-800 focus:ring-offset-1  ">
          ...
          <Disclosure.Panel className="sm:hidden">
            ...
            <div className="border-t border-surface-800 pt-4 pb-3">
              {user ? (
                <>
                  ...
                  <div className="space-y-1">
                    <button
                      onClick={() => signOut()}
                      className="block px-4 py-2 text-base font-medium text-surface-800 hover:text-white"
                    >
                      Sign out
                    </button>
                  </div>
                ...
                <div className="space-y-1">
                  <button
                    ...
                    className="flex w-full px-4 py-2 text-base font-medium text-surface-800 hover:text-white"
                  >
                    Sign in
                  </button>
                </div>
